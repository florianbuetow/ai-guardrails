...
/*1:*/
#line 33 "mmix-arith.w"

#include <stdio.h> 
#include <string.h> 
#include <ctype.h> 
/*2:*/
#line 50 "mmix-arith.w"

#ifdef __STDC__
#define ARGS(list) list
#else
#line 54 "mmix-arith.w"
#define ARGS(list) ()
#endif
#line 56 "mmix-arith.w"

/*:2*/
#line 37 "mmix-arith.w"

typedef enum{false,true}bool;
/*3:*/
#line 61 "mmix-arith.w"
...
/*36:*/
#line 606 "mmix-arith.w"

typedef enum{zro,num,inf,nan}ftype;

/*:36*//*59:*/
#line 1111 "mmix-arith.w"
...
/*:14*/
#line 223 "mmix-arith.w"
;
/*15:*/
#line 238 "mmix-arith.w"
...
;
for(j= 3;j>=0;j--)/*20:*/
#line 275 "mmix-arith.w"

{
/*21:*/
#line 283 "mmix-arith.w"
...
/*:21*/
#line 277 "mmix-arith.w"
;
/*22:*/
#line 295 "mmix-arith.w"
...
/*:33*/
#line 526 "mmix-arith.w"
;
}

/*:31*//*34:*/
#line 552 "mmix-arith.w"
...
else if(o<0x800000)exceptions|= U_BIT;
if(s=='-')o|= sign_bit;
return o;

/*:35*/
#line 577 "mmix-arith.w"
;
}

/*:34*//*37:*/
#line 609 "mmix-arith.w"
...
/*:48*/
#line 825 "mmix-arith.w"
;
d= ye-ze;
xs= ys,xe= ye;
if(d)/*49:*/
#line 860 "mmix-arith.w"

{
if(d<=2)zf= shift_right(zf,d,1);
else if(d> 54)zf.h= 0,zf.l= 1;
else{
...
/*:51*/
#line 913 "mmix-arith.w"
;
}

/*:50*//*54:*/
#line 973 "mmix-arith.w"
...
/*:66*/
#line 981 "mmix-arith.w"
;
if(x.h&sign_bit)printf("-");
/*55:*/
#line 1020 "mmix-arith.w"

f= shift_left(x,1);
e= f.h>>21;
f.h&= 0x1fffff;
if(!f.h&&!f.l)/*57:*/
#line 1046 "mmix-arith.w"
...
/*:67*/
#line 987 "mmix-arith.w"
;
}

/*:54*//*60:*/
#line 1121 "mmix-arith.w"
...
/*:79*/
#line 1465 "mmix-arith.w"
;
/*83:*/
#line 1529 "mmix-arith.w"
...
/*:83*/
#line 1466 "mmix-arith.w"
;
packit:/*84:*/
#line 1562 "mmix-arith.w"
...
/*:84*/
#line 1467 "mmix-arith.w"
;
return 1;
}

/*:78*/
#line 1411 "mmix-arith.w"
;
...
/*:72*/
#line 1356 "mmix-arith.w"
;
no_const_found:next_char= s;return-1;
}

/*:68*//*82:*/
#line 1514 "mmix-arith.w"
...
/*:87*/
#line 1626 "mmix-arith.w"
;
}
}

/*:86*//*88:*/
#line 1653 "mmix-arith.w"
...
/*:90*/
#line 1706 "mmix-arith.w"
;
return fpack(z,e,s,r);
}

/*:89*//*91:*/
#line 1721 "mmix-arith.w"
...
case 4*num+num:/*94:*/
#line 1812 "mmix-arith.w"

odd= 0;
thresh= ye-delta;
if(thresh<ze)thresh= ze;
while(ye>=thresh)/*95:*/
#line 1833 "mmix-arith.w"
