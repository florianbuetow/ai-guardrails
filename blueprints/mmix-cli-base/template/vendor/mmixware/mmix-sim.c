...
/*:11*//*43:*/
#line 1127 "mmix-sim.w"

#include <sys/types.h> 
#include <sys/stat.h> 

/*:43*//*46:*/
#line 1163 "mmix-sim.w"

#ifndef SEEK_SET
#define SEEK_SET 0 
#endif
#line 1167 "mmix-sim.w"

/*:46*/
#line 2888 "mmix-sim.w"
...
/*:38*//*39:*/
#line 1078 "mmix-sim.w"

typedef char Char;

/*:39*//*54:*/
#line 1274 "mmix-sim.w"
...
/*:48*//*52:*/
#line 1257 "mmix-sim.w"

octa implied_loc;
bool profile_started;

/*:52*//*56:*/
#line 1317 "mmix-sim.w"
...
/*:61*//*65:*/
#line 1460 "mmix-sim.w"

op_info info[256]= {
/*66:*/
#line 1467 "mmix-sim.w"
...
/*:69*/
#line 1465 "mmix-sim.w"
};

/*:65*//*76:*/
#line 1781 "mmix-sim.w"
...
/*:121*//*129:*/
#line 2683 "mmix-sim.w"

bool showing_stats;
bool just_traced;

/*:129*//*139:*/
#line 2853 "mmix-sim.w"
...
/*:49*/
#line 1180 "mmix-sim.w"

else if(shown_line==cur_line)return;
...
/*:51*/
#line 1233 "mmix-sim.w"
;
if(p->right)print_freqs(p->right);
}

/*:50*//*82:*/
#line 1864 "mmix-sim.w"
...
/*:115*/
#line 2483 "mmix-sim.w"

else/*116:*/
#line 2499 "mmix-sim.w"
...
/*:118*/
#line 2528 "mmix-sim.w"

else/*119:*/
#line 2540 "mmix-sim.w"
...
/*:119*/
#line 2529 "mmix-sim.w"
;
}
}

/*:117*//*120:*/
#line 2557 "mmix-sim.w"
...
/*:145*/
#line 2981 "mmix-sim.w"
;return;
case'D':/*146:*/
#line 3055 "mmix-sim.w"
...
/*:62*//*75:*/
#line 1778 "mmix-sim.w"

register int G,L,O;

/*:75*/
#line 2897 "mmix-sim.w"
;
mmix_io_init();
/*142:*/
...
if(!*cur_arg)scan_option("?",true);
argc-= cur_arg-argv;

/*:142*/
#line 2899 "mmix-sim.w"
;
/*14:*/
#line 660 "mmix-sim.w"
...
/*:147*/
#line 2900 "mmix-sim.w"
;
/*163:*/
#line 3373 "mmix-sim.w"
...
breakpoint= false;
if(interacting)/*149:*/
#line 3072 "mmix-sim.w"

{register int repeating;
interact:/*150:*/
#line 3108 "mmix-sim.w"
...
/*:152*/
#line 3084 "mmix-sim.w"
;
/*153:*/
#line 3174 "mmix-sim.w"
...
/*:155*/
#line 3191 "mmix-sim.w"
;break;

/*:153*/
#line 3085 "mmix-sim.w"
;
/*161:*/
#line 3318 "mmix-sim.w"
...
while(repeating)/*156:*/
#line 3230 "mmix-sim.w"

{
if(cur_disp_set)/*157:*/
#line 3241 "mmix-sim.w"
...
/*:157*/
#line 3232 "mmix-sim.w"
;
/*159:*/
#line 3275 "mmix-sim.w"
...
/*:149*/
#line 2907 "mmix-sim.w"
;
}
if(halted)break;
do/*60:*/
#line 1358 "mmix-sim.w"

{
if(resuming)loc= incr(inst_ptr,-4),inst= g[rX].l;
else/*63:*/
#line 1413 "mmix-sim.w"
...
;
/*71:*/
#line 1738 "mmix-sim.w"

if(resuming&&rop!=RESUME_AGAIN)
/*126:*/
#line 2639 "mmix-sim.w"
...
/*:126*/
#line 1740 "mmix-sim.w"

else{
if(f&X_is_source_bit)/*74:*/
#line 1772 "mmix-sim.w"
...
;
if(info[op].third_operand)/*79:*/
#line 1838 "mmix-sim.w"

b= g[info[op].third_operand];

/*:79*/
#line 1743 "mmix-sim.w"
;
if(f&Z_is_immed_bit)z.l= zz;
else if(f&Z_is_source_bit)/*72:*/
#line 1760 "mmix-sim.w"
...
/*:78*/
#line 1746 "mmix-sim.w"
;
if(f&Y_is_immed_bit)y.l= yy;
else if(f&Y_is_source_bit)/*73:*/
#line 1766 "mmix-sim.w"
...
/*:73*/
#line 1748 "mmix-sim.w"
;
}

/*:71*/
#line 1366 "mmix-sim.w"
;
if(f&X_is_dest_bit)/*80:*/
#line 1841 "mmix-sim.w"
...
/*:80*/
#line 1368 "mmix-sim.w"
;
w= oplus(y,z);
if(loc.h>=0x20000000)goto privileged_inst;
switch(op){
/*84:*/
#line 1920 "mmix-sim.w"
...
strcpy(rhs,"%z = %#z");
if(xx>=8){
if(xx<=11&&xx!=8)goto illegal_inst;
if(xx<=18)goto privileged_inst;
if(xx==rA)/*100:*/
#line 2232 "mmix-sim.w"
...
/*:99*/
#line 2209 "mmix-sim.w"
;
}
g[xx]= z;zz= xx;break;

/*:97*//*101:*/
#line 2241 "mmix-sim.w"
...
/*:111*/
#line 2392 "mmix-sim.w"
;
switch(yy){
case Halt:/*109:*/
#line 2408 "mmix-sim.w"
...
/*:125*/
#line 2615 "mmix-sim.w"
;
break;

/*:124*/
#line 1372 "mmix-sim.w"
;
}
/*122:*/
#line 2585 "mmix-sim.w"
...
/*:130*/
#line 2673 "mmix-sim.w"
;
/*131:*/
#line 2711 "mmix-sim.w"

if(lhs[0]=='!')printf("%s instruction!\n",lhs+1);
else{
/*132:*/
#line 2726 "mmix-sim.w"
